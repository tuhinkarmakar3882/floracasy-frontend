...
export default {
    ...
    return {
      ...
      options: [
        ...
        },
        {
          ...
          color: '#f5a049',
          route: navigationRoutes.Home.MoreOptions.WriteAndEarn.index,
        },
        {
          name: 'Refer & Earn',
          icon: 'mdi mdi-account-multiple-plus',
          color: '#00B4B4',
          route: navigationRoutes.Home.MoreOptions.ReferAndEarn.index,
        },
        {
          name: 'About Us',
        ...
        },
        {
          ...
          color: '#ABEDAB',
          route: navigationRoutes.Home.MoreOptions.FAQ,
        },
      ],
    }
  },
  ...
  methods: {
    async performLogout() {
      ...
      await this.$store.dispatch('UserManagement/clearUserState')
