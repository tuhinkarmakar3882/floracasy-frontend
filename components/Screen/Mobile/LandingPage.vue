<template>
  <section class="mobile-landing-page">
      ...
      <template #slides>
        ...
        <section class="carousel-item px-6">
          <header class="text-center">
            ...
            <p class="my-4 muted">
              We want to be versatile, starting with you, with a growing number
              of enriching content & categories
            </p>
          </header>
          <main class="step-2">
            <section
        ...
        <section class="carousel-item px-6">
          <header class="text-center">
            ...
            <p class="my-4 muted">
              A platform where people can socialize, share ideas, grow & create
              impact together.
            </p>
          </header>
